...
import com.example.penjualan.model.Barang
    ...
    class DataBarangAdapter(val barang: List<Barang?>?, val onMenuClicked: OnMenuClicked): RecyclerView.Adapter<DataBarangAdapter.MyHolder>(){
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataBarangAdapter.MyHolder {
        ...
        override fun onBindViewHolder(holder: DataBarangAdapter.MyHolder, position: Int) {
